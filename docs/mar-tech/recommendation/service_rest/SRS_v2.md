...
- [service_main/SRS_msb_v1.md](../service_main/SRS_msb_v1.md) — модуль импорта данных МСБ (источник для стратегии 3).
...
| Термин | Определение |
|--------|-------------|
| **МСБ** | Название модуля. Расшифровка — малый и средний бизнес. Сегмент и источник аккаунтов для стратегии 3 (база компаний с категориями, подкатегориями и геолокациями). |
