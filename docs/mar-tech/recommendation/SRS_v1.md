...
> **Область:** Документ описывает Решение v1.0 — стратегии 1 (коллаборативная фильтрация) и 2 (по категории соцсети). v2.0 (2ГИС, сегментация, композит) — отдельный scope.
